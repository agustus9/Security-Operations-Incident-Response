...
- 🧱 [**Fortigate Firewall Traffic Analytics**](./01-Splunk-Firewall-Dashboard/fortigate_blocked_countries.json): Monitors baseline perimeter traffic flow, inbound connection volumes, and geographic origins to detect reconnaissance using `iplocation` and field handling filters.
