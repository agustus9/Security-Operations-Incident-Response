...
#### 🧱 [Fortigate Firewall Traffic Analytics](./01-Splunk-Firewall-Dashboard)
...
#### 🚨 [Suricata Intrusion Detection (IDS/IPS) Center](./01-Splunk-Firewall-Dashboard/suricata_ids_dashboard.xml)
...
#### 🔑 [Brute Force Account Takeover Detection](./02-Microsoft-Sentinel-KQL)
